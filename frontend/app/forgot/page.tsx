    ...
    <div className="min-h-screen flex items-center justify-center px-5">
      <div className="w-full max-w-sm">
        <Link href="/" className="flex items-center justify-center gap-2 mb-8">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#c96442] to-[#d8a08a] flex items-center justify-center shadow-glow"><Sparkles size={16} className="text-white" /></div>
        ...
        <div className="glass-strong rounded-2xl p-6 shadow-panel">
          {sent ? (
            <div className="text-center py-4">
              ...
              <Link href="/login" className="text-sm text-[#c96442] hover:underline">Back to login</Link>
            </div>
          ) : (
            <>
              ...
              <form onSubmit={submit} className="space-y-3">
                ...
                <button type="submit" disabled={loading} className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg text-white bg-gradient-to-r from-[#c96442] to-[#b5593a] hover:opacity-90 disabled:opacity-50 transition shadow-glow font-medium">
                  {loading ? <Loader2 size={16} className="animate-spin" /> : 'Send reset link'}
                </button>
              </form>
              <div className="mt-4 text-center text-sm text-slate-500"><Link href="/login" className="text-[#c96442] hover:underline">Back to login</Link></div>
            </>
          )}
        </div>
      </div>
