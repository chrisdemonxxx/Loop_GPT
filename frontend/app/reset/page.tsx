        ...
        <div className="glass-strong rounded-2xl p-6 shadow-panel">
          {done ? (
            <div className="text-center py-4">
              ...
              <Link href="/login" className="inline-block px-4 py-2 rounded-lg text-white bg-gradient-to-r from-[#c96442] to-[#b5593a] shadow-glow text-sm font-medium">Go to login →</Link>
            </div>
          ) : (
            <>
