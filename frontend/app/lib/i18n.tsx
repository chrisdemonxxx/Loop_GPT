...
export const copy = {
  ...
  uploadFile: 'Upload a file', addPhoto: 'Add photo', takePhoto: 'Take a photo',
...
const french: Dict = {
  ...
  uploadFile: 'Téléverser un fichier', addPhoto: 'Ajouter une photo', takePhoto: 'Prendre une photo',
